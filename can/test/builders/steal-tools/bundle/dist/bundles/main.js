...
System.bundles = {"bundles/one":["components/one/one.stache!can/view/stache/stache","components/one/one"]};
/*config.js*/
...
define('main', [
    ...
    if (!$__2 || !$__2.__esModule)
        $__2 = { default: $__2 };
    var can = $__0.default;
    var tmpl = $__2.default;
    window.MODULE = { html: tmpl().childNodes[0].innerHTML };
    return {};
});
